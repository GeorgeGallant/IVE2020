...
public class SpeechToText_v2 : MonoBehaviour
{
    ...
    private string subscription_key = "c23410a601b74a1782766c68ef3f44f7";
    private string region_name = "canadacentral";

    // YOUR-APP-ID: The App ID GUID found on the www.luis.ai Application Settings page.
    private string appId = "70c9a26e-877c-4d94-a0a0-ff5197d4a2e9";

    // YOUR-PREDICTION-KEY: 32 character key.
    private string predictionKey = "3180862a6aa54c06b16d91bf18279daa";

    // YOUR-PREDICTION-ENDPOINT: Example is "https://westus.api.cognitive.microsoft.com/"
    private string predictionEndpoint = "https://p360v.cognitiveservices.azure.com/";
    ...
    public async void ButtonClick(SteamVR_Action_Boolean fromAction, SteamVR_Input_Sources fromSource)
    {
        ...
        Debug.Log(FeedbackAnswers[0].ToString());
        Debug.Log(FeedbackAnswers[1].ToString());
    ...
    public void CheckSumScore()
    {
        try
        {
            ...
            if (FeedbackAnswers[0].ToString() == GoodSceneIntent && Convert.ToDouble(FeedbackAnswers[1]) > 0.3)
            {
